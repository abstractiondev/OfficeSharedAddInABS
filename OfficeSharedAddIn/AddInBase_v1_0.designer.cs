...
namespace PresentationTracker
{
	...
	public class Connect : Object, Extensibility.IDTExtensibility2 , IRibbonExtensibility
	{
				...
				private EApplication_SlideShowNextSlideEventHandler _TweetSlideChangeField;
			    private void RegisterEvents(Application powerPointApp)
	    {
	            ...
	            powerPointApp.PresentationOpen += _WarnForTweeterField;                
			        ...
			        {
	            _TweetSlideChangeField = new EApplication_SlideShowNextSlideEventHandler(HandlerForEvent_TweetSlideChange_SlideShowNextSlide);
	            powerPointApp.SlideShowNextSlide += _TweetSlideChangeField;                
	        }
			    }
			    ...
			    private void HandlerForEvent_WarnForTweeter_PresentationOpen(Presentation presentation)
	    {
	        ...
	        EventHandlerImpl.WarnForTweeter_PresentationOpen(powerpointApplication, presentation);
			    ...
			    private void HandlerForEvent_TweetSlideChange_SlideShowNextSlide(SlideShowWindow slideShowWindow)
	    {
            Application powerpointApplication = (Application)applicationObject;
	        EventHandlerImpl.TweetSlideChange_SlideShowNextSlide(powerpointApplication, slideShowWindow);
	    }
